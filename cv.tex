...
& Master Thesis on sensor fusion for autonomous driving \cite{Galvez2015Thesis}. Advisor: Prof. John \textsc{Folkesson}, Examiner: Prof. Patric \textsc{Jensfelt}.
\textsc{GPA}: A.\\
&\\
...
& Lectures and seminars in robotics. Project: lidar-based obstacle avoidance. \\
&\\
...
& Development of algorithms for sensor data fusion, including lidar, radar and camera, in the context of Volvo Cars' autonomous driving project \emph{Drive Me}. Experience in high-perfomance computing, safety-critical coding as well as the ISO 26262 standard. Agile development and continuous integration workflow.  \\
&\\
%------------------------------------------------
...
& Development of an vision-based parking occupancy estimation system, using OpenCV and Qt libraries. Involved in the national project "Ciudad 2020". In collaboration with the at ETSIT-UPM. 
...
& Development and integration of a new educational platform for the study of ARM microcontrollers at the Electronic Systems Laboratory.\\
...
& \\
\textsc{Oct} 2014 - \textsc{Dec} 2014 & \textbf{Robot for the \emph{Robotics and Autonomous Systems} course}. Control, 3D object recognition, mapping and localization. \\
& \\

\textsc{Sep} 2012 - \textsc{Jan} 2013 & \textbf{Augmented Reality mobile application}. Real-time visual tracking and control of robots. Special Project for the \emph{Digital Electronics Systems Laboratory} course.   \\
& \\
...
\textsc{Sep} 2011 - \textsc{Jan} 2012 & \textbf{Adversarial learning through genetic algorithms}. Predator-prey robot learning simulation. Project for the \emph{Introduction to Intelligent Robotics} course.\\
