...
\begin{center}
	\faBirthdayCake ~ December 29\textsuperscript{th} 1991 \qquad 
	\faGlobe ~ Spanish \qquad
	\faMapMarker ~ Gothenburg, Sweden \qquad
	\faPhone ~ +46 72 966 9146 
	
	\faEnvelope ~ \href{mailto:carlosgalvezp@gmail.com}{carlosgalvezp@gmail.com} \qquad
	\faGithub ~ \href{https://github.com/carlosgalvezp}{carlosgalvezp} \qquad
	\faLinkedin ~ \href{https://www.linkedin.com/in/carlos-galvez/}{carlos-galvez} \qquad
\end{center}
...
\begin{tabular}{R{\widthone}|p{\widthtwo}}
	...
	& Development of algorithms for sensor data fusion, including lidar, radar and camera, in the context of Volvo Cars' autonomous driving project \emph{Drive Me}. Experience in high-performance computing (CUDA, OpenGL), safety-critical code as well as the ISO 26262 standard. Agile development and continuous integration workflow.  \\
	&\\
	%------------------------------------------------
...
\noindent
\begin{tabular}{R{\widthone}|L{\widthtwo}}
\textsc{Proficient} & C/C++, Python, Git, \textsc{Matlab} \& \textsc{Simulink}, OpenCV, PCL, ROS.\\
\textsc{Intermediate} & TensorFlow, Keras, CMake, OpenGL, OpenCL, CUDA, Qt, Bash, Docker, Gerrit, \LaTeX.\\
\textsc{Basic} & Java, HTML, CSS, JavaScript, J2EE, SQL, Android, ASM, VHDL.\\
